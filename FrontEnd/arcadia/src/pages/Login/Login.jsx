...
function Login() {
  ...
  //função para redirecionar o usuario para a HOME
  ...
  async function handleLogin(e) {
    ...
    try {
      const response = await api.post("/auth/login", {
        //aqui o front faz a requisição para o back
        email,
        password,
      });
      ...
      toast.success("Login realizado com sucesso!"); //auto explicativo isso aqui
